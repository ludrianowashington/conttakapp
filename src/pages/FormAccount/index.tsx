...
export default function FormAccount() {
    ...
    const iconSelect = (selectedItem: number) => {
        ...
        if (selectedItem === 0) return <FontAwesome name='bank' size={size} color={color} />
        if (selectedItem === 1) return <FontAwesome name='credit-card' size={size} color={color} />
    }
            ...
            <ScrollView style={styles.viewInputs}>
                <View style={styles.form}>
                    ...
                    <Pressable style={styles.formInputs}>
                        <Text style={styles.textForm}>Tipo</Text>
                        <Text style={styles.buttonForm}>tipo_cartao</Text>
                    </Pressable>
                    <Pressable style={styles.formInputs}>
                    ...
                    <Pressable style={styles.formInputs}>
                        <Text style={styles.textForm}>Vencimento</Text>
